# Streamdata.io API Gallery - Mobypicture Dev Team Profiling
This is a repository for managing the profiling of Mobypicture Dev Team. Right now, it is just a Github repository, README, and an [APIs.json](apis.md) outlining some of the details of Mobypicture Dev Team, including different links and artificats defining their operation.
...
Once there is an OpenAPI for Mobypicture Dev Team, it will be available within the [Streamdata.io API Gallery](http://api.gallery.streamdata.io/), until then the companies profile will be used in a variety of other sites and applications.
